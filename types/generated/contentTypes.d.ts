...
export interface ApiDisputeDispute extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    reason: Schema.Attribute.Enumeration<
      ['ITEM_NOT_RECEIVED', 'DAMAGED_PRODUCT', 'WRONG_ITEM', 'PAYMENT_ISSUE']
    >;
    recievedBy: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
...
export interface ApiMarketplaceSettingMarketplaceSetting
  ...
  attributes: {
    ...
    currency: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'TBH'>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    buyer: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    buyerProtectionFee: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliveryMethod: Schema.Attribute.Enumeration<['pickup', 'home']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    orderStatus: Schema.Attribute.Enumeration<
      ['placed', 'in progress', 'shipped', 'delivered', 'cancelled']
    > &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    accountType: Schema.Attribute.Enumeration<['user', 'admin']> &
    ...
    facebookLinked: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    fav_products: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    >;
    firstName: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    rating_avg: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 1;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    savedBanks: Schema.Attribute.JSON;
    savedCards: Schema.Attribute.JSON;
    shippingSettings: Schema.Attribute.JSON;
    subdistrictCode: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
    ...
    written_reviews: Schema.Attribute.Relation<
      'oneToMany',
      'api::review.review'
    >;
  };
